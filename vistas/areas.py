...
class VistaAreas(ctk.CTkFrame):
    ...
    def abrir_formulario_area(self, area_editar=None):
        ...
        ctk.CTkLabel(vent, text="Piso:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=50, pady=(5,0))
        combo_piso = ctk.CTkComboBox(vent, values=["Piso 2", "Piso 1", "Piso 0", "Piso -1"], width=400)
        combo_piso.pack(pady=5)
        ...
        if area_editar:
            ...
            if area_editar.get("piso"):
                combo_piso.set(area_editar["piso"])
